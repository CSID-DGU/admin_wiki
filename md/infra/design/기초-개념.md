...
이 문서는 [시스템 아키텍처](시스템-아키텍처.md)에 나오는 리눅스, Kubernetes, 저장소 용어를 설명한다. 실제 배포 순서와 장애 대응은 [운영 매뉴얼](../operations/운영-매뉴얼.md)에서 다룬다.
...
코드 주석이나 예전 배포 기록에 `subPath` 방식이 남아 있을 수 있으므로, 현재 Pod 스펙과 혼동하지 않는다.
