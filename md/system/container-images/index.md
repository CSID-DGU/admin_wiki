...
조합별 image를 제공한다. **설계**는 공통 entrypoint의 런타임 구성과 image
variant를 설명하고, **운영**은 빌드·배포에 사용하는 명령, 테스트 전략과 변경
절차를 설명한다.
...
| --- | --- |
| 현재 페이지 | 책임 범위와 문서 안내 |
| [설계](design.md) | 개요, 계정·홈·SSH·Jupyter·VNC·Kerberos 구성, CUDA/TensorFlow variant별 차이, 디렉터리 지도 |
