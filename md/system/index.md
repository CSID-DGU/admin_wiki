...
| `remote-operations/` 설계 | [문서 열기](remote-operations-설계.md) | [PDF 열기](../../pdf/system/remote-operations-design-manual.pdf) |
| `remote-operations/` 운영 | [문서 열기](remote-operations-운영.md) | [PDF 열기](../../pdf/system/remote-operations-operations-manual.pdf) |
| `remote-operations/` 설정 | [문서 열기](remote-operations-설정.md) | [PDF 열기](../../pdf/system/remote-operations-config-manual.pdf) |
