...
| 검증일 | 상태 | 문제 | 핵심 결론 |
| --- | --- | --- | --- |
| 2026-09-16 | 원인 확정, 영구 조치 적용·운영 검증 완료 | [keytab 배포가 100초 넘게 걸린 원인](farm-keytab-deploy-systemd-stall.md) | 로그인마다 뜨는 소리 서버가 블루투스를 기다려 systemd 본체가 90초 멈췄고, 그 사이 배포 스크립트의 불필요한 `daemon-reload`가 붙잡혔음. 조치 후 0.4~1.2초 |
